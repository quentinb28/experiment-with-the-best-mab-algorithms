...
1. [Running Docker Image](#Running-Docker-Image)
2. [Background](#Background)
3. [Part 1: Greedy Algorithms](#Part-1:-Greedy-Algorithms)
4. [Part 2: Optimistic Initial Values](#Part-2:-Optimistic-Initial-Values)
5. [Part 3: UCB1](#Part-3:-UCB1)
6. [Part 4: Thompson Sampling](#Part-4:-Thompson-Sampling)
...
## 4. Part 2: Optimistic Initial Values

## 5. Part 3: UCB1

## 6. Part 4: Thompson Sampling
